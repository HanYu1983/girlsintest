...
app.page.HeaderController.HeaderController.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4139__auto__,k4967,else__4140__auto__){var self__ = this;
var this__4139__auto____$1 = this;var G__4969 = k4967;switch (G__4969) {
default:
...
app.page.HeaderController.HeaderController.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4144__auto__,k__4145__auto__,G__4966){var self__ = this;
var this__4144__auto____$1 = this;var pred__4970 = cljs.core.keyword_identical_QMARK_;var expr__4971 = k__4145__auto__;return (new app.page.HeaderController.HeaderController(self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4145__auto__,G__4966),null));
});
...
app.page.HeaderController.HeaderController.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4136__auto__,G__4966){var self__ = this;
var this__4136__auto____$1 = this;return (new app.page.HeaderController.HeaderController(G__4966,self__.__extmap,self__.__hash));
});
...
app.page.HeaderController.map__GT_HeaderController = (function map__GT_HeaderController(G__4968){return (new app.page.HeaderController.HeaderController(null,cljs.core.dissoc.call(null,G__4968)));
});
...
app.page.HeaderController.open = (function open(this$){return app.page.HeaderController.show.call(null,app.page.HeaderController.view.call(null,this$),new cljs.core.Keyword(null,"home","home",-74557309));
});
app.page.HeaderController.close = (function close(this$){return close.call(null,app.page.HeaderController.view.call(null,this$));
});
app.page.HeaderController.set_view_BANG_ = (function set_view_BANG_(this$,view){return cljs.core.reset_BANG_.call(null,view.call(null,this$),view);
});
...
app.page.HeaderController.HeaderController.prototype.app$controller$IController$set_view_BANG_$arity$2 = (function (this$,view){var this$__$1 = this;return app.page.HeaderController.set_view_BANG_.call(null,this$__$1,view);
});

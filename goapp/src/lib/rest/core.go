...
func RestWithConfig(path string, filePathFn func(string) string, cacheVersion string, handlers map[string]func(string, *os.File, http.ResponseWriter, *http.Request)) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		filePath := path + filePathFn(r.URL.Path)

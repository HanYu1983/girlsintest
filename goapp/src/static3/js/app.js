...
(function() {
  var CloseablePageList, PageBigPhoto, PageCelebrity, PageEvent, PageHome, PageModels, PageModelsList, PageNews, PageProduct, PageProductList, PageStreetsnap, PageStreetsnapList;
  ...
  CloseablePageList = [PageHome, PageCelebrity, PageModels, PageModelsList, PageEvent, PageStreetsnap, PageStreetsnapList, PageProduct, PageProductList, PageNews];
  ...
  window.app.Main = (function() {
      ...
      this.menubar.event.on('onMenubarBtnClick', (function(_this) {
        return function(e, id) {
          switch (id) {
            ...
            case 'btn_nav_product':
              return _this.router.navigate('productList', {
                trigger: true
              });
            case 'btn_nav_news':
    ...
    Main.prototype.bindEvent = function(name, controller) {
      switch (name) {
        ...
        case PageProduct:
          controller.event.on('onImgHistoryClick', (function(_this) {
            return function() {
              return _this.onProductImgHistoryClick.apply(_this, arguments);
            };
          })(this));
          controller.event.on('onImgClick', (function(_this) {
            return function() {
        ...
        case PageProductList:
          controller.event.on('onBtnSearchClick', (function(_this) {
            return function() {
              return _this.onProductBtnSearchClick.apply(_this, arguments);
            };
          })(this));
          controller.event.on('onBtnModelClick', (function(_this) {
            return function() {
              return _this.onProductBtnModelClick.apply(_this, arguments);
            };
          })(this));
          return controller.event.on('onBtnReturnClick', (function(_this) {
            return function() {
              return _this.onProductBtnReturnClick.apply(_this, arguments);
            };
          })(this));
        case PageBigPhoto:
    ...
    Main.prototype.onProductImgHistoryClick = function(evt, _arg) {
      var id;
      id = _arg.id;
      return this.router.navigate("product/id=" + id, {
        trigger: true
      });
    };
    ...
    Main.prototype.onProductBtnSearchClick = function(evt, params) {
      return this.router.navigate('productList/search=' + params.search, {
        trigger: true
      });
    };

    Main.prototype.onProductBtnModelClick = function(evt, params) {
      return this.router.navigate('product/id=' + params.id, {
        trigger: true
      });
    };

    Main.prototype.onProductBtnReturnClick = function(evt, params) {
      return this.router.navigate('productList', {
        trigger: true
      });
    };

...
goog.require('app.controller');
app.core.main = (function main(){var this$ = cljs.core.atom.call(null,null);var coll_pages = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var mc_pageContainer = $("#mc_pageContainer");var mc_popupContainer = $("#mc_popupContainer");var mc_loading = $("#mc_loading");var header = (function (){var G__4986 = app.page.HeaderController.create.call(null);app.controller.set_view2.call(null,G__4986,app.page.HeaderView.create.call(null,$("#mc_header")));
return G__4986;
})();app.event.onHeaderBtnBackhomeClick.subscribe(cljs.core.partial.call(null,app.core.onHeaderBtnBackhomeClick,this$));

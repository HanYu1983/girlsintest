...
{{
var G__13781 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13781;
continue;
}
} else
...
{var pred__13785 = cljs.core._EQ_;var expr__13786 = limit;if(cljs.core.truth_(pred__13785.call(null,(1),expr__13786)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13785.call(null,(2),expr__13786)))
...
var G__13788 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13789 = (limit__$1 - (1));
var G__13790 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13788;
limit__$1 = G__13789;
parts = G__13790;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13792 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13792))
{var replacement_13793 = temp__4124__auto___13792;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13793)));
} else
{buffer.append(ch);
}
{
var G__13794 = (index + (1));
index = G__13794;
continue;
}
}

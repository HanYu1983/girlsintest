...
return (function (p1__4993_SHARP_){return core.app.OpenView.call(null,p1__4993_SHARP_,new cljs.core.Keyword(null,"Page1","Page1",-154479013),cljs.core.partial.call(null,core.model.CreatePage1Model,ctx));
});})(ctx))
);
});
...
{if(cljs.core.truth_(pred__4998.call(null,"btn_nav_event",expr__4999)))
...
{if(cljs.core.truth_(pred__4998.call(null,"btn_nav_model",expr__4999)))
...
{if(cljs.core.truth_(pred__4998.call(null,"btn_nav_streetSnap",expr__4999)))
...
{if(cljs.core.truth_(pred__4998.call(null,"btn_nav_product",expr__4999)))
...
return (function (p1__4994_SHARP_){return core.app.OpenView.call(null,p1__4994_SHARP_,new cljs.core.Keyword(null,"Home","Home",1521501280),cljs.core.partial.call(null,core.model.CreateHomeModel,ctx));
});})(root,ctx))
);
});

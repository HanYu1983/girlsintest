...
return (function (evt){var that = this;var btnSelf = $(that);var btnOver = btnSelf.find(".navover");return btnOver.animate((function (){var obj5299 = {"width":"0px"};return obj5299;
})(),(300));
});})(menubar__$1))
;var handleBtnMouseOver = ((function (menubar__$1,handleBtnMouseOut){
return (function (evt){var that = this;var btnSelf = $(that);var btnOver = btnSelf.find(".navover");return btnOver.animate((function (){var obj5301 = {"width":"120px"};return obj5301;
})(),(300));
...
return (function (evt){var that = this;var id = that.id;var route = (function (){var pred__5302 = cljs.core._EQ_;var expr__5303 = id;if(cljs.core.truth_(pred__5302.call(null,"btn_nav_celebrity",expr__5303)))
...
{if(cljs.core.truth_(pred__5302.call(null,"btn_nav_event",expr__5303)))
...
{if(cljs.core.truth_(pred__5302.call(null,"btn_nav_model",expr__5303)))
...
{if(cljs.core.truth_(pred__5302.call(null,"btn_nav_streetSnap",expr__5303)))
...
{if(cljs.core.truth_(pred__5302.call(null,"btn_nav_product",expr__5303)))
...
return (function (p1__5305_SHARP_){return cljs.core.apply.call(null,cljs.core.partial.call(null,tool.app.Route,ctx),p1__5305_SHARP_);
});})(root,ctx))
);
return cljs.core.swap_BANG_.call(null,ctx,((function (root,ctx){
return (function (p1__5306_SHARP_){return tool.app.OpenView.call(null,p1__5306_SHARP_,new cljs.core.Keyword(null,"Home","Home",1521501280),cljs.core.partial.call(null,core.model.CreateHomeModel,ctx));
});})(root,ctx))
);
});

...
return (function (evt){var that = this;var btnSelf = $(that);var btnOver = btnSelf.find(".navover");return btnOver.animate((function (){var obj6021 = {"width":"0px"};return obj6021;
})(),(300));
});})(menubar__$1))
;var handleBtnMouseOver = ((function (menubar__$1,handleBtnMouseOut){
return (function (evt){var that = this;var btnSelf = $(that);var btnOver = btnSelf.find(".navover");return btnOver.animate((function (){var obj6023 = {"width":"120px"};return obj6023;
})(),(300));
...
return (function (evt){var that = this;var id = that.id;var route = (function (){var pred__6024 = cljs.core._EQ_;var expr__6025 = id;if(cljs.core.truth_(pred__6024.call(null,"btn_nav_celebrity",expr__6025)))
...
{if(cljs.core.truth_(pred__6024.call(null,"btn_nav_event",expr__6025)))
...
{if(cljs.core.truth_(pred__6024.call(null,"btn_nav_model",expr__6025)))
...
{if(cljs.core.truth_(pred__6024.call(null,"btn_nav_streetSnap",expr__6025)))
...
{if(cljs.core.truth_(pred__6024.call(null,"btn_nav_product",expr__6025)))
...
return (function (p1__6027_SHARP_){return cljs.core.apply.call(null,cljs.core.partial.call(null,tool.app.Route,ctx),p1__6027_SHARP_);
});})(root,ctx))
);
return cljs.core.swap_BANG_.call(null,ctx,((function (root,ctx){
return (function (p1__6028_SHARP_){return tool.app.OpenView.call(null,p1__6028_SHARP_,new cljs.core.Keyword(null,"Home","Home",1521501280),cljs.core.partial.call(null,core.model.CreateHomeModel,ctx,null,new cljs.core.Keyword(null,"Home","Home",1521501280),null));
});})(root,ctx))
);
});

...
return (function (p1__5056_SHARP_){return core.app.OpenView.call(null,p1__5056_SHARP_,new cljs.core.Keyword(null,"Page1","Page1",-154479013),cljs.core.partial.call(null,core.model.CreatePage1Model,ctx));
});})(ctx))
);
});
...
core.main.testIndex3 = (function testIndex3(){var root = $(".root");var ctx = cljs.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"views","views",1450155487),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"container","container",-1736937707),root.find("#mc_pageContainer"),new cljs.core.Keyword(null,"route","route",329891309),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Home","Home",1521501280),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"toModel","toModel",-1645669175),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"StreetSnapList","StreetSnapList",-230935816),core.model.CreateStreetSnapListModel], null),new cljs.core.Keyword(null,"toStreetSnapList","toStreetSnapList",1144464750),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"StreetSnapList","StreetSnapList",-230935816),core.model.CreateStreetSnapListModel], null),new cljs.core.Keyword(null,"toProduct","toProduct",-912176427),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"StreetSnapList","StreetSnapList",-230935816),core.model.CreateStreetSnapListModel], null)], null)], null)], null));core.main.initHeader.call(null,root);
core.event.OnMenubarBtnClick.subscribe(((function (root,ctx){
return (function (id){var pred__5061 = cljs.core._EQ_;var expr__5062 = id;if(cljs.core.truth_(pred__5061.call(null,"btn_nav_celebrity",expr__5062)))
...
{if(cljs.core.truth_(pred__5061.call(null,"btn_nav_event",expr__5062)))
...
{if(cljs.core.truth_(pred__5061.call(null,"btn_nav_model",expr__5062)))
{return core.app.Route.call(null,ctx,new cljs.core.Keyword(null,"Home","Home",1521501280),new cljs.core.Keyword(null,"toModel","toModel",-1645669175),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"model","model",331153215)], null));
} else
{if(cljs.core.truth_(pred__5061.call(null,"btn_nav_streetSnap",expr__5062)))
{return core.app.Route.call(null,ctx,new cljs.core.Keyword(null,"Home","Home",1521501280),new cljs.core.Keyword(null,"toStreetSnapList","toStreetSnapList",1144464750),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"street","street",1870012303)], null));
} else
{if(cljs.core.truth_(pred__5061.call(null,"btn_nav_product",expr__5062)))
{return core.app.Route.call(null,ctx,new cljs.core.Keyword(null,"Home","Home",1521501280),new cljs.core.Keyword(null,"toProduct","toProduct",-912176427),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"product","product",1363474257)], null));
} else
...
return (function (p1__5057_SHARP_){return core.app.OpenView.call(null,p1__5057_SHARP_,new cljs.core.Keyword(null,"Home","Home",1521501280),cljs.core.partial.call(null,core.model.CreateHomeModel,ctx));
});})(root,ctx))
);
});
core.main.testFn = (function testFn(){var G__5065 = core.fn.GetAllModelBy.call(null,"config.json","product");G__5065.done(((function (G__5065){
return (function (){return console.log(arguments);
});})(G__5065))
);
G__5065.fail(((function (G__5065){

...
return (function (evt){var that = this;var btnSelf = $(that);var btnOver = btnSelf.find(".navover");return btnOver.animate((function (){var obj5062 = {"width":"0px"};return obj5062;
})(),(300));
});})(menubar__$1))
;var handleBtnMouseOver = ((function (menubar__$1,handleBtnMouseOut){
return (function (evt){var that = this;var btnSelf = $(that);var btnOver = btnSelf.find(".navover");return btnOver.animate((function (){var obj5064 = {"width":"120px"};return obj5064;
})(),(300));
...
{if(cljs.core.truth_(pred__5069.call(null,"btn_nav_event",expr__5070)))
...
{if(cljs.core.truth_(pred__5069.call(null,"btn_nav_model",expr__5070)))
...
{if(cljs.core.truth_(pred__5069.call(null,"btn_nav_streetSnap",expr__5070)))
...
{if(cljs.core.truth_(pred__5069.call(null,"btn_nav_product",expr__5070)))
...
return (function (p1__5065_SHARP_){return tool.app.OpenView.call(null,p1__5065_SHARP_,new cljs.core.Keyword(null,"Home","Home",1521501280),cljs.core.partial.call(null,core.model.CreateHomeModel,ctx));
});})(root,ctx))
);
});

...
});var view = tool.app.CreateView.call(null,CreateElem,cljs.core.partial.call(null,tool.app.FadeIn,(400)),tool.app.NormalOut);var G__5989_5990 = view.elemPromise;G__5989_5990.done(((function (G__5989_5990,CreateElem,view){
return (function (elem){return null;
});})(G__5989_5990,CreateElem,view))
);
return view;
}));
...
;var view = tool.app.CreateView.call(null,CreateElem,cljs.core.partial.call(null,tool.app.FadeIn,(400)),CloseFn);var G__5992_5993 = view.elemPromise;G__5992_5993.done(((function (G__5992_5993,CreateElem,view,CloseFn){
return (function (elem){var mc_modelContainer = elem.find("#mc_modelContainer");return mc_modelContainer.delegate("div[modelFrame]","click",((function (mc_modelContainer,G__5992_5993,CreateElem,view,CloseFn){
...
});})(mc_modelContainer,G__5992_5993,CreateElem,view,CloseFn))
);
});})(G__5992_5993,CreateElem,view,CloseFn))
);
return view;
});})(CloseFn))
);
...
;var view = tool.app.CreateView.call(null,CreateElem,cljs.core.partial.call(null,tool.app.FadeIn,(400)),CloseFn);var G__5995_5996 = view.elemPromise;G__5995_5996.done(((function (G__5995_5996,CreateElem,view,CloseFn){
return (function (elem){var mc_historyContainer = elem.find("#mc_historyContainer");var mc_sideContainer = elem.find("#mc_sideContainer");mc_sideContainer.delegate("img","click",((function (mc_historyContainer,mc_sideContainer,G__5995_5996,CreateElem,view,CloseFn){
...
});})(mc_historyContainer,mc_sideContainer,G__5995_5996,CreateElem,view,CloseFn))
);
return mc_historyContainer.delegate("img","click",((function (mc_historyContainer,mc_sideContainer,G__5995_5996,CreateElem,view,CloseFn){
return (function (){var that = this;return core.event.OnRoute.onNext(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [viewname,new cljs.core.Keyword(null,"toDetail","toDetail",1490871748),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),that.id,new cljs.core.Keyword(null,"dto","dto",-2048364190),elem.DTO], null)], null));
});})(mc_historyContainer,mc_sideContainer,G__5995_5996,CreateElem,view,CloseFn))
);
});})(G__5995_5996,CreateElem,view,CloseFn))
);
return view;
});})(CloseFn))
);
